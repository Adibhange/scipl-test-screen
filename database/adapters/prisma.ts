...
export const prismaAdapter: IDatabaseAdapter = {
	...
	questionPapers: {
		listAll: () => notImplemented("questionPapers.listAll"),
		listByUploader: (uploadedBy: string) => notImplemented("questionPapers.listByUploader"),
		getById: (id: string) => notImplemented("questionPapers.getById"),
		getWithItems: (id: string) => notImplemented("questionPapers.getWithItems"),
		getPublished: (roleId: string, experienceId: string) => notImplemented("questionPapers.getPublished"),
		create: (data: any) => notImplemented("questionPapers.create"),
		createItems: (items: any[]) => notImplemented("questionPapers.createItems"),
		updateStatus: (id: string, data: any) => notImplemented("questionPapers.updateStatus"),
		delete: (id: string) => notImplemented("questionPapers.delete"),
		replaceItems: (
			paperId: string,
			actorId: string,
			actorRole: string,
			...
			newItems: any[],
		) => notImplemented("questionPapers.replaceItems"),
	},
	assessmentSnapshots: {
