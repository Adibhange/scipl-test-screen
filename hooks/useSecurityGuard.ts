 ...
 * - Detects browser tab switches / minimization and audits them in the database.
...
export function useSecurityGuard({
  ...
  // Detect browser window visibility changes and log them relationally
  useEffect(() => {
  ...
  }, [hasStarted, allSubmitted, setTabSwitches, setShowWarning, candidateId]);
